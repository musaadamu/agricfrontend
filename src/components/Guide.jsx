    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-100/30 to-transparent blur-3xl"></div>
          <div className="relative">
            <div className="inline-block p-2 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl shadow-xl mb-6">
              <div className="bg-white rounded-xl px-8 py-6">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-red-600 via-orange-600 to-red-700 bg-clip-text text-transparent leading-tight">
                  Journal of Vocational<br />Teacher Education
                </h1>
            ...
            <p className="text-base text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Published by the School of Secondary Education (Vocational)<br />
              Federal College of Education (Technical), Potiskum
            </p>
            <div className="mt-8 w-24 h-1 bg-gradient-to-r from-red-600 to-orange-600 mx-auto rounded-full"></div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-red-200 overflow-hidden">
            ...
            <div className="p-8">
              <p className="text-lg text-gray-700 leading-relaxed">
                Papers submitted to JOVOTE are rigorously reviewed for their contribution to Vocational Teacher Education,
                Technical Education, Teacher Training, and advancing general knowledge. The journal welcomes
                scholarly articles encompassing research reports in Vocational Education, Technical Skills Development,
                Teacher Professional Development, Curriculum Innovation, and Educational Technology.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-red-900 mb-4">Terms of Acceptance</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-red-600 to-orange-600 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className={`bg-gradient-to-br ${item.gradient} rounded-xl p-6 border border-red-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-red-900 mb-4">Manuscript Requirements</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-red-600 to-orange-600 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-red-200 hover:shadow-xl transition-all duration-300">
                <div className="bg-gradient-to-r from-red-600 to-orange-600 w-12 h-12 rounded-xl flex items-center justify-center text-white text-xl mb-4">
                  {item.icon}
                </div>
                <h3 className="text-xl font-bold text-red-900 mb-3">{item.title}</h3>
                <p className="text-gray-700 leading-relaxed">{item.content}</p>
        ...
        {/* Contact Information */}
        <div className="mb-12">
          <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-8 text-white">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/10 rounded-xl p-4 sm:p-6 backdrop-blur-sm">
                  <h3 className="text-lg sm:text-xl font-bold mb-4 text-red-100">Payment & Submission Address</h3>
                  <div className="space-y-2 text-red-50 text-sm sm:text-base">
                    <p className="font-semibold">The Editor-in-Chief</p>
                    <p className="break-words">Journal of Vocational Teacher Education (JOVOTE)</p>
                    <p className="break-words">School of Secondary Education (Vocational)</p>
                ...
                <div className="bg-white/10 rounded-xl p-4 sm:p-6 backdrop-blur-sm">
                  <h3 className="text-lg sm:text-xl font-bold mb-4 text-red-100">Contact Details</h3>
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        <span className="text-sm">📧</span>
                      </div>
                      <p className="text-red-50 text-sm sm:text-base break-all">jovote2025@gmail.com</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        <span className="text-sm">📱</span>
        ...
        {/* Important Notes */}
        <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl border border-red-200 p-8 shadow-lg">
          <div className="flex items-center mb-6">
            <div className="w-12 h-12 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl flex items-center justify-center text-white text-xl mr-4">
              ⚠️
            </div>
            <h3 className="text-2xl font-bold text-red-900">Important Submission Notes</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              "JOVOTE retains copyright for all accepted articles"
            ].map((note, index) => (
              <div key={index} className="flex items-start space-x-3">
                ...
                <p className="text-red-900 font-medium">{note}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="text-center mt-16 pt-8 border-t border-red-200">
          <p className="text-gray-600 mb-4">
            © 2025 Journal of Vocational Teacher Education (JOVOTE)
          </p>
